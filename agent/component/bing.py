...
class BingParam(ComponentParamBase):
    ...
    def check(self):
        ...
        self.check_valid_value(
            self.channel, "Bing Web Search or Bing News", ["Webpages", "News"]
        )
...
class Bing(ComponentBase, ABC):
    ...
    def _run(self, history, **kwargs):
        ...
        try:
            headers = {
                "Ocp-Apim-Subscription-Key": self._param.api_key,
                "Accept-Language": self._param.language,
            }
            params = {
                "q": ans,
                "textDecorations": True,
                "textFormat": "HTML",
                "cc": self._param.country,
                "answerCount": 1,
                "promote": self._param.channel,
            }
            if self._param.channel == "Webpages":
                ...
                bing_res = [
                    ...
                    for i in search_results["news"]["value"]
                ]
